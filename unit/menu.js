...
function menu(app){
    ...
    app.post('/outRecord/getoutRecordMsg.do',(req,res)=>{//查询出门详情
     var rows =  getTestData({
              obj:{
                  'id' : 'am1-4',
                  'flogin' : 'am8-8',
                  'fname' : 'DD3-3',	
            ...
            for(var a = 0,d;d=rows[a];a++){
              d.ftype = getRound(1,4) ;
              d.finfo = JSON.stringify(getTestData({
                obj:{
                    'key' : 'HH3-9',
                    'value' : 'am8-8'
                },
